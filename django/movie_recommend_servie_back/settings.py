"""
Django settings for movie_recommend_servie_back project.
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware',  # SessionMiddleware 이후로 이동
...
WSGI_APPLICATION = 'movie_recommend_servie_back.wsgi.application'
